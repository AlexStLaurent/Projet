...
<asp:Content ID="Content2" ContentPlaceHolderID="Form" runat="server">
    <asp:GridView runat="server" ID="gdvGestion" OnSelectedIndexChanged="gdvGestion_SelectedIndexChanged" OnRowCommand="gdvGestion_RowCommand">
        <Columns>
            ...
            <asp:ButtonField CommandName="Delete" HeaderText="" ShowHeader="false" Text="Terminer réservation"  />
        </Columns>
    </asp:GridView>
</asp:Content>
